...
local module = {}
module.eq = function(WeaponType)
	local plr = game.Players.LocalPlayer
	local Char = plr.Character
	local Backpack = plr.Backpack
	if not Char or not Backpack then return end
	local Type = WeaponType or (_G.CONFIG_["UseSword"] and "Sword" or "Melee")
	for _, Tool in pairs(Backpack:GetChildren()) do
		if Tool:IsA("Tool") and Tool:FindFirstChild("ToolTip") and Tool.ToolTip == Type then
